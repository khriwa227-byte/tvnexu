        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-left">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="https://wa.me/447832486269?text=Hallo%20TvLux!%20Ik%20heb%20een%20vraag%20over%20uw%20IPTV%20pakketten." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-[13px] text-slate-500 hover:text-sky-400 transition-colors">
